# WalkRW2ls, linearized rimless wheel with step length changing with speed

export WalkRW2ls
@with_kw struct WalkRW2ls <: AbstractWalkRW2
...
function onestep(w::WalkRW2ls; vm=w.vm, P=w.P, δangle = 0.,
    ...
    newα = α + cstep*(vm-vmstar) # where s = v^0.42, ds = 0.42*v^(0.42-1)*dv, cstep = 0.71 for typical
